...
void push_buttons_init(void) /**Configuration for the push buttons*/
{
...
//	GPIO_callback_init(GPIO_A, change_signal);
//	GPIO_callback_init(GPIO_C, change_freq);
